...
| **Image export** | High-quality PNG (2× pixel ratio), self-contained SVG, A4 PDF. Every CSS rule, custom property and flag image is inlined so the export matches the live view. |
